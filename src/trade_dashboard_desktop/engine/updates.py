...
``{"error": ...}`` so a missing connection never blocks startup.
"""
...
RELEASES_URL = (
    "https://api.github.com/repos/crieck2010/trade-dashboard-desktop/releases/latest"
)
TIMEOUT_SECONDS = 8
...
def check_for_updates(current_version: str, url: str = RELEASES_URL) -> dict:
    ...
    try:
        req = urllib.request.Request(
            url, headers={"User-Agent": "trade-dashboard-desktop", "Accept": "application/vnd.github+json"}
        )
